...
import RolesHandler from "../guards/role.guard";
import parseStringCommand from "./command.parser";
import { HasAccessResult, UsernameValidationResult } from "../guards";
...
// TODO split commands to separate files & (classes | functions)
// TODO move business logic out from CommandsHandler
